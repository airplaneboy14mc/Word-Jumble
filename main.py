...
def main():
	try:
		...
		print("This will select a random word from a predefined list of words and jumble them up.\nYou will then have to guess the word based off of the jumbled letters.")
		#create tuple
		words = init_tuple()
		#choose the word
...
def init_tuple():
	...
	fruits = ('Banana', 'Dragon Fruit', 'Orange', 'Kiwi', 'Apple')
	vegetables = ('Cucumber', 'Bell Pepper', 'Carrot', 'Romain Lettuce', 'Spinach', 'Kale', 'Celery')
